...
Public Class Game
    ...
    Private m_reverse As Boolean = True
    Private m_generatingTimer As Boolean = True
    ...
    Private Sub Main() Handles Me.Load
        ...
        If m_grid.gridHeight + m_spaceYBorder * 2 + 50 < 460 Then
            tempHeight = 460
        ...
        'Initialize timer
        m_lblTimer = New Label
        m_lblTimer.AutoSize = True
        m_lblTimer.TextAlign = ContentAlignment.MiddleCenter
        m_lblTimer.Font = New Font("Calibri", 12, FontStyle.Bold)
        m_lblTimer.Name = "lblTimer"
        m_lblTimer.Location = New Point(m_grid.gridWidth + m_spaceXBorder * 2, m_spaceYBorder + 150)
        m_lblTimer.Text = "Timer:" & Environment.NewLine & CStr(5)
        m_lblTimer.ForeColor = ColorTranslator.FromOle(RGB(187, 173, 160))
        Me.Controls.Add(m_lblTimer)
    ...
    Private Sub btnRestart_Click(sender As Object, e As EventArgs) Handles m_btnRestart.Click
        m_grid.InitializeBoard()
    End Sub
    Public Function timerLabel() As Label
        Return m_lblTimer
    End Function
    Public Property generatingTimer() As Boolean
        Get
            Return m_generatingTimer
        End Get
